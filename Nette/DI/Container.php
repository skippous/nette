...
class Container extends Nette\Object
{
	...
	{
		if (func_num_args() > 2) {
			throw new Nette\DeprecatedException('Parameter $meta has been deprecated.');
	...
	public function findByType($class)
	{
		...
		return isset($this->meta[self::TYPES][$class]) ? array_keys($this->meta[self::TYPES][$class]) : array();
	}
